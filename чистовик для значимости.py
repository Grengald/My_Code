...
# Длинный профиль
ax1.bar(JD_Long_1, CR_Long_1, width=width, edgecolor='blue', facecolor='none', label='Long Profile')
...
# Короткий профиль
ax1.bar(JD_Short, Short_Profile*5, width=width, edgecolor='green', facecolor='none', label='Short Profile x5')
...
ax1.bar(S_z_1, np.array(S_w_1) * 5, width=width, edgecolor='red', facecolor='red', label='Max Significance')

# Вертикальная линия для максимальной счетной скорости
ax1.axvline(JD_Short[N_Short_Profile_Max], linestyle='--', color='red', label='Max Count Rate')
