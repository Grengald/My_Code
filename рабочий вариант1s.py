...
file_path = 'C:\\Users\\Grengald\\Desktop\\Котинг\\ИКИ РАН\\Sav bd\\GRB080411.sav'
...
ax1.plot(JD_Long_1, BG_Long, color='black', label='Background Long', linestyle='--')
...
ax1.plot(JD_Short, BG_Short*5, color='purple', label='Background Short x5', linestyle='--')
