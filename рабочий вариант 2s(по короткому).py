...
##################################################################################################################
if Short_Profile[N_Short_Profile_Max-1]>Short_Profile[N_Short_Profile_Max+1]:
    if Short_Profile[N_Short_Profile_Max]%2==0:
        N_Short_Profile_Rebin = N_Short_Profile // 2  
        n = 0
        a = 1
        m = 0
        Short_Profile_Rebin = [0] * N_Short_Profile_Rebin
        CR_Long_1_Rebin = [0] * N_Short_Profile_Rebin
        JD_Long_1_Rebin = [0] * N_Short_Profile_Rebin
        JD_Short_Rebin = [0] * N_Short_Profile_Rebin
        while a < N_Short_Profile:
    ...
    elif Short_Profile[N_Short_Profile_Max]%2==1:
        N_Short_Profile_Rebin = N_Short_Profile // 2 - 1  
        n = 1
        a = 2
        m = 0
        Short_Profile_Rebin = [0] * N_Short_Profile_Rebin
...
elif Short_Profile[N_Short_Profile_Max-1]<Short_Profile[N_Short_Profile_Max+1]:
    if Short_Profile[N_Short_Profile_Max]%2==0:
        N_Short_Profile_Rebin = N_Short_Profile // 2 - 1
        n = 1
        a = 2
...
#print(len(Short_Profile_Err_Rebin))
#print(len(Signal_Long_1))
#print(len(Signal_Short))
#print(len(CR_Long_1_Err_Rebin))
#print(len(CR_Long_1_Rebin))
